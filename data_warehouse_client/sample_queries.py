...
plot_measurements.plot_measurement_type(dw, ms2, 152, 4, 'output/example2.png')
...
res = dw.get_measurements_with_value_test(155, 3, "> 9")
print_functions.print_measurements(res)
