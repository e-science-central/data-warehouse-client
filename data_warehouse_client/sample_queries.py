...
io_functions.print_measurements(mgis)
...
io_functions.print_measurements(ms4)
io_functions.plot_measurement_type(dw, ms4, 155, 3, 'output/example2.png')

print("\nQ13: Create a CSV file for all measurements in study 3 with type = 155 where the value is greater that 9\n")
io_functions.export_measurements_as_csv(ms4, 'output/example2.csv')

print("\nQ14: All measurements in group 15")
ms5 = dw.get_measurements(measurement_group=15)
io_functions.print_measurements(ms5)
...
io_functions.print_measurement_group_instances(dw, mgs6, 15, 2)
print("\nParticipants: ")
...
io_functions.print_measurements(ms6a)

ms6b = dw.get_measurement_group_instances_for_cohort(15, 2, [4], [])
io_functions.print_measurements(ms6b)
...
io_functions.print_measurement_group_instances(dw, ms8, 15, 2)
io_functions.export_measurement_groups_as_csv(dw, ms8, 15, 2, 'output/example17.csv')

print("\nQ18: All measurements for Study 5\n")
ms18 = dw.get_measurements(study=5)
io_functions.print_measurements(ms18)
...
io_functions.print_measurement_group_instances(dw, mgs19, 20, 5)

print("\n   : store in CSV file\n")
io_functions.export_measurement_groups_as_csv(dw, mgs19, 20, 5, 'output/example19.csv')
...
io_functions.print_measurement_group_instances(dw, mgs20, 20, 5)
...
io_functions.print_measurement_group_instances(dw, mgs21, 20, 5)
...
io_functions.print_rows(ms22, ms22Header)
...
io_functions.print_measurements(ms23)
...
io_functions.print_measurements(ms26)
print("\n")
mgs26 = transform_result_format.form_measurement_group(dw, 10, ms26)
io_functions.print_measurement_group_instances(dw, mgs26, 6, 10)
