--
-- PostgreSQL script for creating a new data warehouse
--
-- Run this script while connected to the database the schema is to be applied
-- to from within psql, as a database super user, using
--
-- postgres=# \i <this_file_name.sql>
--
-- Robin Wardle, November 2024
